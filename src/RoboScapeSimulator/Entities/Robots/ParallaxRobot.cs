...
namespace RoboScapeSimulator.Entities.Robots
{
    ...
    public class ParallaxRobot : Robot
    {
        ...
        public ParallaxRobot(Room room, in Vector3? position = null, in Quaternion? rotation = null, bool debug = false, in VisualInfo? visualInfo = null, float spawnHeight = 0.4f, IUdpClient? client = null) : base(room, position, rotation, visualInfo: visualInfo, spawnHeight: spawnHeight, client: client ?? new UdpClientWrapper())
        {
            CreateHandlers();
