...
{
    class TreasureHuntEnvironment : EnvironmentConfiguration
    {
        ...
        public override void Setup(Room room)
        {
            ...
            var barrel = new Cube(room, initialPosition: new Vector3(3, 0, 3), initialOrientation: Quaternion.Identity, visualInfo: new VisualInfo() { ModelName = "chest_opt.glb", ModelScale = 0.4f }, isKinematic: true);
